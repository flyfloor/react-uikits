...
var Form = function (_Component) {
    ...
    _createClass(Form, [{
        ...
        value: function afterValidateError(_ref) {
            var _this3 = this;
        ...
        value: function validate() {
            ...
            if (name && !rules[name]) {
                return this.afterValidateError({ field: name, afterCallback: afterCallback })(function (errors) {
            ...
            vBuilder.validate(storeData, function (errors, errObj) {
                ...
                return _this4.afterValidateError({ field: name, afterCallback: afterCallback })(function (errors) {
                    return errors ? fail && fail.call(_this4, errors) : success && success.call(_this4, submitData);
                });
            });
        }
